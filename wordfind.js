  ...
  var n = function () {
      var n = "abcdefghijklmnoprstuvwy",
        ...
        e = {
          ...
          diagonalBack: function (n, r, t) {
            return { x: t - 1, y: n >= t - 1 ? r + 1 : r };
          },
          diagonalUp: function (n, r, t) {
            return { x: 0, y: t - 1 > r ? t - 1 : r + 1 };
          },
          diagonalUpBack: function (n, r, t) {
            return { x: t - 1, y: n >= t - 1 ? r + 1 : r };
          },
        ...
        i = function (n, r) {
          ...
          for (t = 0, e = n.length; e > t; t++) if (!a(i, r, n[t])) return null;
          return i;
        },
        a = function (n, r, o) {
          var e = l(n, r, o);
        ...
        l = function (n, r, i) {
          for (
            var a = [],
              ...
              g = 0,
              v = 0,
              p = r.orientations.length;
            p > v;
            v++
          )
            for (
              var d = r.orientations[v],
                s = o[d],
                x = t[d],
                y = e[d],
                k = 0,
              ...
              if (s(k, B, l, c, h)) {
                var w = u(i, n, k, B, x);
                (w >= g || (!r.preferOverlap && w > -1)) &&
                  ((g = w), a.push({ x: k, y: B, orientation: d, overlap: w })),
                  k++,
                  k >= c && ((k = 0), B++);
              } else {
                var U = y(k, B, h);
        ...
        f = function (n, r) {
          for (var t = [], o = 0, e = n.length; e > o; o++)
            n[o].overlap >= r && t.push(n[o]);
          return t;
        },
      ...
      return {
        ...
        solve: function (n, t) {
          for (
            ...
            var f = t[a],
              c = l(n, o, f);
            c.length > 0 && c[0].overlap === f.length
              ? ((c[0].word = f), e.push(c[0]))
              : i.push(f);
          }
          return { found: e, notFound: i };
        },
        print: function (n) {
          for (var r = "", t = 0, o = n.length; o > t; t++) {
            for (var e = n[t], i = 0, a = e.length; a > i; i++)
              r += ("" === e[i] ? " " : e[i]) + " ";
            r += "\n";
          }
    ...
    r = "undefined" != typeof exports && null !== exports ? exports : window;
  r.wordfind = n();
}).call(this);
